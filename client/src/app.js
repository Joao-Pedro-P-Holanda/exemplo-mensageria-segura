...
if (window.__SecureChatInitialized) {
	console.warn("SecureChat app already initialized. Skipping duplicate execution.")
} else {
	window.__SecureChatInitialized = true
	console.log("SecureChat app initializing...")
